		...
		<div class="h_right">
	        ...
	        <nav class="nav">
	            <ul class="nav-list">
	                ...
	                <li class="nav-item"><a href="<?php echo base_url()."layout/about";?>">About</a></li>
	                <li class="nav-item"><a href="<?php echo base_url()."layout/portofolio";?>">Portofolio</a></li>
	                <li class="nav-item"><a href="<?php echo base_url()."layout/blog";?>">Blog</a></li>
	                <li class="nav-item"><a href="<?php echo base_url()."layout/contact";?>">Contact</a></li>
	                <div class="clear"></div>
	            </ul>
	        </nav>
